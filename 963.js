...
function clearOrigin() {
    ...
    localStorage.removeItem('originSidebarHeader');
    updateInputFields();
    setupDirectionsButton(); // Allow setting a new origin or destination
}
...
function clearDestination() {
    ...
    localStorage.removeItem('destinationSidebarHeader');
    updateInputFields();
    map.on('click', setDestinationOnClick); // Allow setting a new destination on map click
}
    ...
    if (directionsButton) {
        directionsButton.addEventListener('click', function() {
            ...
            if (selectedMarkerData) {
                ...
                console.log("Directions set with selected marker:", originSidebarHeader, destinationSidebarHeader);
...
function setDestinationOnClick(e) {
    ...
    if (selectedMarkerData) {
        ...
        console.log("Destination set with selected marker:", destinationSidebarHeader);
    } else {
        destinationCoordinates = [lng, lat];
        destinationSidebarHeader = `${lat}, ${lng}`;
        setDirectionsInputFields(originSidebarHeader || '', destinationSidebarHeader);
        ...
        console.log("Destination set with map click:", destinationSidebarHeader);
    }

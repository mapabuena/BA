...
function setDestinationOnClick(e) {
    if (destinationSet || !originSet || !directions) return; // Prevent further clicks if destination is already set, origin is not set, or directions control is not initialized

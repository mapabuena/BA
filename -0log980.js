...
function addRoutePopup(route, index, profile) {
    ...
    const backgroundColor = index === 0 ? 'rgba(255, 255, 255, 0.75)' : 'rgba(169, 169, 169, 0.75)';
    const popupClass = index === 0 ? 'best-route-popup' : 'second-route-popup';
    ...
    const popup = new mapboxgl.Popup({
        closeButton: false,
        closeOnClick: false,
        className: index === 0 ? 'route-popup primary' : 'route-popup alternative'
    })
    .setLngLat(midPoint)

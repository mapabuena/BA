...
function adjustMarkerSizes() {
    ...
    const scaleFactor = 0.1; // Adjust this factor to control the scaling sensitivity
    const sizeMultiplier = Math.pow(2, (zoom - 17) * scaleFactor); // Adjust the scale factor as necessary

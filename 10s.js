...
const searchBar = document.getElementById('search-inputs');  // Make sure this ID is correct
  if (!searchBar) {
    console.error('Search bar element not found!');
    return;
  }
  
  const listContainer = document.getElementById('search-list');  // Make sure this ID is correct
  if (!listContainer) {

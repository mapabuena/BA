  ...
  const closeDirectionsButton = document.getElementById('close-directions');
    ...
    originInput.addEventListener('input', function() {
        if (originInput.value) {
            // Implement logic to set and save originCoordinates and originSidebarHeader
        } else {
            originCoordinates = null;
            originSidebarHeader = null;
            localStorage.removeItem('originCoordinates');
    ...
    map.on('click', function(e) {
        ...
        if (activeInput === originInput) {
            ...
            originSidebarHeader = `${lat}, ${lng}`; // Or use a reverse geocoding service for a human-readable address
    ...
    if (originCoordinates && destinationCoordinates) {
        ...
        .then(data => {
            ...
            if (data.routes && data.routes.length > 0) {
                // Clear existing directions and initialize with new profile
                if (directions) {
                ...
                console.log("Updating profile with origin:", originSidebarHeader, "and destination:", destinationSidebarHeader);

        ...
        const observer = new MutationObserver(mutations => {
            mutations.forEach(mutation => {
                if (mutation.type === 'attributes' && mutation.attributeName === 'value') {
                    console.log("Destination input value changed:", destinationInput.value);
                    ...
                    if (destinationInput.value !== storedDestinationTitle) {
                        ...
                        console.log("Reverted destination input value to stored title:", storedDestinationTitle);
                    }
                }
            });
        });
...
function setDirectionsInputFields(originTitle, destinationTitle) {
    ...
    if (originTitle && originInput) {
        originInput.value = originTitle;
        console.log("Origin input value set to:", originTitle);
    }
    if (destinationTitle && destinationInput) {
        destinationInput.value = destinationTitle;
        console.log("Destination input value set to:", destinationTitle);
    }
}

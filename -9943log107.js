...
document.getElementById('custom-cycling').addEventListener('click', function() {
    changeProfile('mapbox/cycling');
});

document.getElementById('custom-walking').addEventListener('click', function() {
    changeProfile('mapbox/walking');
});

...
function initializeDirectionsControl(profile = 'mapbox/driving') {
    if (directions) {
        map.removeControl(directions); // Remove existing directions control
    }
...
function setupDirectionsButton() {
    ...
    document.getElementById('drive-profile').addEventListener('click', () => {
        initializeDirectionsControl('mapbox/driving');
    });

    document.getElementById('walk-profile').addEventListener('click', () => {
        initializeDirectionsControl('mapbox/walking');
    });

    document.getElementById('cycle-profile').addEventListener('click', () => {
        initializeDirectionsControl('mapbox/cycling');
    });
}

...
function setOriginOnClick(e) {
    ...
    if (selectedMarker && selectedMarker.data) {
        ...
        try {
            ...
            const originInput = document.querySelector('.mapbox-directions-origin input');
            originInput.value = originSidebarHeader;
            console.log("Directly setting origin input value:", originSidebarHeader);

            setDirectionsInputFields(origin.properties.title, '');

            const observer = new MutationObserver(() => {
                if (originInput.value !== originSidebarHeader) {
                    originInput.value = originSidebarHeader;
                    console.log("Reapplied origin sidebarheader:", originSidebarHeader);
                }
            });

            observer.observe(originInput, {
                attributes: true,
                attributeFilter: ['value'],
                childList: true,
                subtree: true,
            ...
            console.log("Origin set successfully with properties:", origin.properties);
        } catch (error) {

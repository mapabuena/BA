...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var loadNYButton = document.getElementById('loadNYButton');
    if (loadNYButton) {
        loadNYButton.addEventListener('click', function() {
            loadCSV('https://raw.githubusercontent.com/mapabuena/BA/main/NewYorkPinsGroups.csv', 40.7128, -74.0060);
        });
       }

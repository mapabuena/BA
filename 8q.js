...
function applyFilters() {
    ...
    console.log("Filtering from:", startDateTimeInput, "to", endDateTimeInput);
    console.log("Parsed dates:", startDateTime, endDateTime);

    markers.forEach(({ marker, data }) => {
        console.log(`Checking marker for ${data.name}`);
        console.log("Date Ranges:", data.dateRanges);
        ...
        console.log(`Visibility by Category: ${isVisibleByCategory}`);
        console.log(`Visibility by Date: ${isVisibleByDate}`);
